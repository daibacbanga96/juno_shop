    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Danh mục giày xăng đan</h3>
        </div>
        <div class="box-body">
        ...
        <div class="box-footer">
            ...
            <a class="btn btn-primary" href="{{asset('admin/addcatechild')}}">Thêm</a>
        </div>
        <!-- /.box-footer-->
      </div>
      <!-- /.box -->
